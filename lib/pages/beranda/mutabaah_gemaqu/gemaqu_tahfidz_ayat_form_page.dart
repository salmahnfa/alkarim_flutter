...
import '../../../models/gemaqu_tahfidz_response.dart';
...
class _GemaQuTahfidzAyatFormPageState extends State<GemaQuTahfidzAyatFormPage> {
  late Future<GemaQuTahfidzAyatData> _future;
  ...
  Future<GemaQuTahfidzAyatData> fetchData() async {
    ...
    final gemaQuTahfidz = await api.request<GemaQuTahfidzResponse>(
    ...
    return GemaQuTahfidzAyatData(gemaQuTahfidz, surahList);
  }
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          final details = snapshot.data?.gemaQuTahfidz.data;
...
class GemaQuTahfidzAyatData {
  final GemaQuTahfidzResponse gemaQuTahfidz;
  final SurahResponse surahList;

  GemaQuTahfidzAyatData(this.gemaQuTahfidz, this.surahList);
}